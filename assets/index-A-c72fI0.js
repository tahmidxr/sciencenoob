 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(G,X){var te=G.length;G.push(X);e:for(;0<te;){var Pe=te-1>>>1,pe=G[Pe];if(0<i(pe,X))G[Pe]=X,G[te]=pe,te=Pe;else break e}}function t(G){return G.length===0?null:G[0]}function r(G){if(G.length===0)return null;var X=G[0],te=G.pop();if(te!==X){G[0]=te;e:for(var Pe=0,pe=G.length,Be=pe>>>1;Pe<Be;){var Bn=2*(Pe+1)-1,zn=G[Bn],$n=Bn+1,qn=G[$n];if(0>i(zn,te))$n<pe&&0>i(qn,zn)?(G[Pe]=qn,G[$n]=te,Pe=$n):(G[Pe]=zn,G[Bn]=te,Pe=Bn);else if($n<pe&&0>i(qn,te))G[Pe]=qn,G[$n]=te,Pe=$n;else break e}}return X}function i(G,X){var te=G.sortIndex-X.sortIndex;return te!==0?te:G.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var u=[],c=[],h=1,f=null,m=3,v=!1,P=!1,b=!1,V=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function A(G){for(var X=t(c);X!==null;){if(X.callback===null)r(c);else if(X.startTime<=G)r(c),X.sortIndex=X.expirationTime,e(u,X);else break;X=t(c)}}function N(G){if(b=!1,A(G),!P)if(t(u)!==null)P=!0,jo(M);else{var X=t(c);X!==null&&Un(N,X.startTime-G)}}function M(G,X){P=!1,b&&(b=!1,S(_),_=-1),v=!0;var te=m;try{for(A(X),f=t(u);f!==null&&(!(f.expirationTime>X)||G&&!C());){var Pe=f.callback;if(typeof Pe=="function"){f.callback=null,m=f.priorityLevel;var pe=Pe(f.expirationTime<=X);X=n.unstable_now(),typeof pe=="function"?f.callback=pe:f===t(u)&&r(u),A(X)}else r(u);f=t(u)}if(f!==null)var Be=!0;else{var Bn=t(c);Bn!==null&&Un(N,Bn.startTime-X),Be=!1}return Be}finally{f=null,m=te,v=!1}}var F=!1,E=null,_=-1,I=5,x=-1;function C(){return!(n.unstable_now()-x<I)}function R(){if(E!==null){var G=n.unstable_now();x=G;var X=!0;try{X=E(!0,G)}finally{X?T():(F=!1,E=null)}}else F=!1}var T;if(typeof w=="function")T=function(){w(R)};else if(typeof MessageChannel<"u"){var _e=new MessageChannel,pi=_e.port2;_e.port1.onmessage=R,T=function(){pi.postMessage(null)}}else T=function(){V(R,0)};function jo(G){E=G,F||(F=!0,T())}function Un(G,X){_=V(function(){G(n.unstable_now())},X)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(G){G.callback=null},n.unstable_continueExecution=function(){P||v||(P=!0,jo(M))},n.unstable_forceFrameRate=function(G){0>G||125<G?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<G?Math.floor(1e3/G):5},n.unstable_getCurrentPriorityLevel=function(){return m},n.unstable_getFirstCallbackNode=function(){return t(u)},n.unstable_next=function(G){switch(m){case 1:case 2:case 3:var X=3;break;default:X=m}var te=m;m=X;try{return G()}finally{m=te}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(G,X){switch(G){case 1:case 2:case 3:case 4:case 5:break;default:G=3}var te=m;m=G;try{return X()}finally{m=te}},n.unstable_scheduleCallback=function(G,X,te){var Pe=n.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?Pe+te:Pe):te=Pe,G){case 1:var pe=-1;break;case 2:pe=250;break;case 5:pe=1073741823;break;case 4:pe=1e4;break;default:pe=5e3}return pe=te+pe,G={id:h++,callback:X,priorityLevel:G,startTime:te,expirationTime:pe,sortIndex:-1},te>Pe?(G.sortIndex=te,e(c,G),t(u)===null&&G===t(c)&&(b?(S(_),_=-1):b=!0,Un(N,te-Pe))):(G.sortIndex=pe,e(u,G),P||v||(P=!0,jo(M))),G},n.unstable_shouldYield=C,n.unstable_wrapCallback=function(G){var X=m;return function(){var te=m;m=X;try{return G.apply(this,arguments)}finally{m=te}}}})(N0);k0.exports=N0;var SR=k0.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const p2=new ye(q.comparator);function jt(){return p2}const NS=new ye(q.comparator);function Ta(...n){let e=NS;for(const t of n)e=e.insert(t.key,t);return e}function DS(n){let e=NS;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Cn(){return Ua()}function VS(){return Ua()}function Ua(){return new hi(n=>n.toString(),(n,e)=>n.isEqual(e))}const m2=new ye(q.comparator),g2=new fe(q.comparator);function ee(...n){let e=g2;for(const t of n)e=e.add(t);return e}const y2=new fe(Z);function Eg(){return y2}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hl{constructor(e,t,r,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,Ql.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Hl(Y.min(),i,new ye(Z),jt(),ee())}}class Ql{constructor(e,t,r,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Ql(r,t,ee(),ee(),ee())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fw{constructor(e){this.Xt=new fe((t,r)=>Ae.comparator(t.field,r.field)),this.collectionId=e.collectionGroup!=null?e.collectionGroup:e.path.lastSegment(),this.en=e.orderBy,this.tn=[];for(const t of e.filters){const r=t;r.isInequality()?this.Xt=this.Xt.add(r):this.tn.push(r)}}get nn(){return this.Xt.size>1}rn(e){if(Q(e.collectionGroup===this.collectionId),this.nn)return!1;const t=Tp(e);if(t!==void 0&&!this.sn(t))return!1;const r=Ti(e);let i=new Set,s=0,o=0;for(;s<r.length&&this.sn(r[s]);++s)i=i.add(r[s].fieldPath.canonicalString());if(s===r.length)return!0;if(this.Xt.size>0){const a=this.Xt.getIterator().getNext();if(!i.has(a.field.canonicalString())){const u=r[s];if(!this.on(a,u)||!this._n(this.en[o++],u))return!1}++s}for(;s<r.length;++s){const a=r[s];if(o>=this.en.length||!this._n(this.en[o++],a))return!1}return!0}an(){if(this.nn)return null;let e=new fe(Ae.comparator);const t=[];for(const r of this.tn)if(!r.field.isKeyField())if(r.op==="array-contains"||r.op==="array-contains-any")t.push(new ac(r.field,2));else{if(e.has(r.field))continue;e=e.add(r.field),t.push(new ac(r.field,0))}for(const r of this.en)r.field.isKeyField()||e.has(r.field)||(e=e.add(r.field),t.push(new ac(r.field,r.dir==="asc"?0:1)));return new Kc(Kc.UNKNOWN_ID,this.collectionId,t,yl.empty())}sn(e){for(const t of this.tn)if(this.on(t,e))return!0;return!1}on(e,t){if(e===void 0||!e.field.isEqual(t.fieldPath))return!1;const r=e.op==="array-contains"||e.op==="array-contains-any";return t.kind===2===r}_n(e,t){return!!e.field.isEqual(t.fieldPath)&&(t.kind===0&&e.dir==="asc"||t.kind===1&&e.dir==="desc")}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lA(n){var e,t;if(Q(n instanceof oe||n instanceof de),n instanceof oe){if(n instanceof RS){const i=((t=(e=n.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(s=>oe.create(n.field,"==",s)))||[];return de.create(i,"or")}return n}const r=n.filters.map(i=>lA(i));return de.create(r,n.op)}function K2(n){if(n.getFilters().length===0)return[];const e=Mp(lA(n));return Q(uA(e)),Op(e)||Lp(e)?[e]:e.getFilters()}function Op(n){return n instanceof oe}function Lp(n){return n instanceof de&&wg(n)}function uA(n){return Op(n)||Lp(n)||function(t){if(t instanceof de&&Rp(t)){for(const r of t.getFilters())if(!Op(r)&&!Lp(r))return!1;return!0}return!1}(n)}function Mp(n){if(Q(n instanceof oe||n instanceof de),n instanceof oe)return n;if(n.filters.length===1)return Mp(n.filters[0]);const e=n.filters.map(r=>Mp(r));let t=de.create(e,n.op);return t=Xc(t),uA(t)?t:(Q(t instanceof de),Q(fo(t)),Q(t.filters.length>1),t.filters.reduce((r,i)=>kg(r,i)))}function kg(n,e){let t;return Q(n instanceof oe||n instanceof de),Q(e instanceof oe||e instanceof de),t=n instanceof oe?e instanceof oe?function(i,s){return de.create([i,s],"and")}(n,e):jw(n,e):e instanceof oe?jw(e,n):function(i,s){if(Q(i.filters.length>0&&s.filters.length>0),fo(i)&&fo(s))return SS(i,s.getFilters());const o=Rp(i)?i:s,a=Rp(i)?s:i,u=o.filters.map(c=>kg(c,a));return de.create(u,"or")}(n,e),Xc(t)}function jw(n,e){if(fo(e))return SS(e,n.getFilters());{const t=e.filters.map(r=>kg(n,r));return de.create(t,"or")}}function Xc(n){if(Q(n instanceof oe||n instanceof de),n instanceof oe)return n;const e=n.getFilters();if(e.length===1)return Xc(e[0]);if(ES(n))return n;const t=e.map(i=>Xc(i)),r=[];return t.forEach(i=>{i instanceof oe?r.push(i):i instanceof de&&(i.op===n.op?r.push(...i.filters):r.push(i))}),r.length===1?r[0]:de.create(r,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dg{constructor(){this.Tr=new fe(Ze.Er),this.dr=new fe(Ze.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Ze(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Ze(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new q(new se([])),r=new Ze(t,e),i=new Ze(t,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new q(new se([])),r=new Ze(t,e),i=new Ze(t,e+1);let s=ee();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const t=new Ze(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Ze{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return q.comparator(e.key,t.key)||Z(e.wr,t.wr)}static Ar(e,t){return Z(e.wr,t.wr)||q.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
